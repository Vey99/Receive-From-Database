...
namespace RecieveFromDB
{
    internal class UserDataClass
    {
        ...
        public UserDataClass(string firstName, string lastName, string email, string cardID, string cardPin, DateTime startTime, DateTime endTime)
        {
            FirstName = firstName;
            LastName = lastName;
            Email = email;
        ...
        public UserDataClass(string firstName, string lastName, string email, string cardID, string cardPin)
        {
            FirstName = firstName;
            LastName = lastName;
            Email = email;
